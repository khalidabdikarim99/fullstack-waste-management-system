...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.user.role !== 'admin') throw new Error("This account does not have administrator privileges");
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-gray-800 px-4 py-8">
      <div className="w-full max-w-4xl flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/2 bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
          ...
          <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">Administrator Login</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-right">
              <Link to="/admin/forgot-password" className="text-sm text-green-600 hover:underline">Forgot Password?</Link>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link to="/login" className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition duration-300 text-sm">User Login</Link>
              <Link to="/recycler/login" className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition duration-300 text-sm">Recycler Login</Link>
              <Link to="/collector/login" className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition duration-300 text-sm">Collector Login</Link>
              <Link to="/employer/login" className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition duration-300 text-sm">Employer Login</Link>
            </div>
          </div>
        </div>
