...
const RecyclerSidebar = () => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: <DashboardIcon />, path: '/recycler/dashboard' },
    { name: 'Shipments', icon: <ShipmentsIcon />, path: '/recycler/shipments' },
    { name: 'Processing', icon: <ProcessingIcon />, path: '/recycler/processing' },
    { name: 'Inventory', icon: <InventoryIcon />, path: '/recycler/inventory' },
    { name: 'Sales', icon: <SalesIcon />, path: '/recycler/sales' },
    { name: 'Reports', icon: <ReportsIcon />, path: '/recycler/reports' },
    { name: 'Communication', icon: <CommunicationIcon />, path: '/recycler/communication' },
    { name: 'Profile', icon: <ProfileIcon />, path: '/recycler/profile' }
  ];
