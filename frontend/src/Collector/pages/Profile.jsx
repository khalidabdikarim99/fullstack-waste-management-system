...
const CollectorProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        if (!token || !user || user.role.toLowerCase() !== "collector") {
          navigate("/collector/login");
          return;
        }

        const res = await fetch(`${API_URL}/auth/collector/profile`, {
          method: "GET",
          headers: {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`${API_URL}/auth/collector/profile/update`, {
        method: "PUT",
        headers: {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`${API_URL}/auth/collector/change-password`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
          ...
          <div className="p-6 grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Collectors play a vital role in reducing landfill waste by gathering recyclable materials.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Create sustainable income by collecting and delivering materials to recycling centers.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Help build a circular economy by connecting waste producers with recycling facilities.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1 capitalize">As a {profile?.role || "collector"}, you're essential to our waste management ecosystem.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white">
            <h2 className="text-2xl font-bold flex items-center gap-2">
              <AccountCircleIcon className="text-3xl" /> Collector Profile
            </h2>
