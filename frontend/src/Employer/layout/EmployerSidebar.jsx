...
const EmployerSidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: '/employer/buy',
      subItems: [
        { name: 'New Order', path: '/employer/buy/new' },
        { name: 'Price Quotes', path: '/employer/buy/quotes' }
      ]
    },
    {
      name: 'Sell Products',
    ...
    },
    {
      ...
      subItems: [
        { name: 'Active', path: '/employer/orders/active' },
        { name: 'History', path: '/employer/orders/history' }
      ]
    },
    {
      name: 'Reports',
    ...
    },
    {
      ...
      subItems: [
        { name: 'With Recyclers', path: '/employer/messages/recyclers' },
        { name: 'With Admin', path: '/employer/messages/admin' }
      ]
    },
    {
      name: 'Profile',
